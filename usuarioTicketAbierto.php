...
<body>
    <nav class="navbar navbar-inverse">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="usuarioTicketAbierto.php"><span class="glyphicon glyphicon-folder-open"></span> Tickets Abiertos</a></li>
            </ul>
    ...
    <div class="container"> 
        ...
        <table  class="table table-striped" >
            ...
            <th>Problema</th>
            <?php
            $sel = $con  -> query("SELECT * FROM tickets WHERE finalizo IS NULL"); //aqui tabla de tickets normales
